...
public sealed class WhisperSettings
{
    ...
    /// <summary>Прогонять ли после остановки диктовки всю запись целиком.</summary>
    /// <remarks>
    /// Пофразная обработка видит фразы по отдельности, поэтому не может
    /// согласовать между ними формы слов и пунктуацию. Проход по всей диктовке
